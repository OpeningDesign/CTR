...
Bearign capacity:  & 1.17 & 1.00 & EQ1613B\\
...
\tablefirsthead{\hline
\multicolumn{1}{|c|}{\textsc{Reinforcements mur T4ph2}}\\\hline
}
\tablehead{\hline
...
\textbf{Reinforcement 1 (outside reinforcement dowels) :} \\
  ...
  Bending check: Md=   0.00 kN m, MR=  99.62kN m  F(M)= 370105512389011.12 OK!\\
  Shear check: Vd=  13.38 kN,  VR= 199.37 kN  F(V)= 14.90 OK!\\
  Stress check: M=   0.00 kN m, $\sigma_s$=   0.00 MPa\\
    $\sigma_{lim}$= 230.00 MPa  F($\sigma_s$)= 315137461021360.50 OK!\\
