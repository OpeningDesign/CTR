...
# roofForcePerUnitLength= thirdFlHeight*(leewardWallPressure-leewardWallPressure)/2.0+parapetHeight*(parapetWindwardWallPressure-parapetLeewardWallPressure)
# thirdFlForcePerUnitLength= (secondFlHeight*(leewardWallPressure-leewardWallPressure)+thirdFlHeight*(leewardWallPressure-leewardWallPressure))/2.0
# secondFlForcePerUnitLength= (firstFlHeight*(leewardWallPressure-leewardWallPressure)+secondFlHeight*(leewardWallPressure-leewardWallPressure))/2.0

# Forces on floors
length= 33.9731
secondFlWindwardForce= length*secondFlLeewardForcePerUnitLength
thirdFlWindwardForce= length*thirdFlLeewardForcePerUnitLength
roofWindwardForce= length*roofLeewardForcePerUnitLength
...
secondFlLines= [secondFll1,secondFll2,secondFll3,secondFll4]
...
for p in [thirdFlPt2,thirdFlPt3,thirdFlPt4]:
    n= p.getNode()
    modelSpace.fixNode00F(n.tag)
for p in [secondFlPt2,secondFlPt3,secondFlPt4]:
    n= p.getNode()
    modelSpace.fixNode00F(n.tag)
...
for e in roofSet.getElements:
    e.vector2dUniformLoadGlobal(xc.Vector([0.0,-roofLeewardForcePerUnitLength]))
for e in thirdFlSet.getElements:
    e.vector2dUniformLoadGlobal(xc.Vector([0.0,-thirdFlLeewardForcePerUnitLength]))
for e in secondFlSet.getElements:
    e.vector2dUniformLoadGlobal(xc.Vector([0.0,-secondFlLeewardForcePerUnitLength]))
...
secondFlReactions[0]+= thirdFlReactions[0]
