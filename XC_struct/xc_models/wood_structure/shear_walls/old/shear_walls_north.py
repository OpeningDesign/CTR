...
roofPt7= pointHandler.newPntFromPos3d(geom.Pos3d(L1+L2+L3+L4+L5+L6,0.0,zRoof))
...
thirdFlPt7= pointHandler.newPntFromPos3d(geom.Pos3d(L1+L2+L3+L4+L5+L6,0.0,zThirdFl))
...
secondFlPt7= pointHandler.newPntFromPos3d(geom.Pos3d(L1+L2+L3+L4+L5+L6,0.0,zSecondFl))
...
roofLines= [roofl1,roofl2,roofl3,roofl4,roofl5,roofl6]
...
thirdFlLines= [thirdFll1,thirdFll2,thirdFll3,thirdFll4,thirdFll5,thirdFll6]
...
secondFlLines= [secondFll1,secondFll2,secondFll3,secondFll4,secondFll5,secondFll6]
...
# Constraints
for p in [roofPt2,roofPt3,roofPt4,roofPt5,roofPt6]:
    n= p.getNode()
    modelSpace.fixNode00F(n.tag)
for p in [thirdFlPt2,thirdFlPt3,thirdFlPt4,thirdFlPt5,thirdFlPt6]:
    n= p.getNode()
    modelSpace.fixNode00F(n.tag)
for p in [secondFlPt2,secondFlPt3,secondFlPt4,secondFlPt5,secondFlPt6]:
    n= p.getNode()
    modelSpace.fixNode00F(n.tag)
...
print('secondFl: ', secondFlReactions[0]/1e3, secondFlReactions[1]/1e3, secondFlReactions[2]/1e3, secondFlReactions[3]/1e3, secondFlReactions[4]/1e3)
