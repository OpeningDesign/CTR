...
depthC= 24*inchToMeter-lowerChordSectionGeometry.h+centroidOffset
...
## Truss C
lowerChordAxisC= geom.Segment3d(geom.Pos3d(0.0,0.0,0.0),geom.Pos3d(9.82345,0.0,0.0))
upperChordAxisC= geom.Segment3d(geom.Pos3d(0.0,0.0,depthC),geom.Pos3d(9.82345,0.0,depthC))
...
lowerChordAxisD= geom.Segment3d(geom.Pos3d(12.4422,0.0,trussDGap),geom.Pos3d(21.80845,0.0,trussDGap))
upperChordAxisD= geom.Segment3d(geom.Pos3d(12.4422,0.0,depthD+trussDGap),geom.Pos3d(21.80845,0.0,depthD+trussDGap))
