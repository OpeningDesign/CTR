...
## Truss C
lowerChordAxisC= geom.Segment3d(geom.Pos3d(0.0,0.0,0.0),geom.Pos3d(10.0038,0.0,0.0))
upperChordAxisC= geom.Segment3d(geom.Pos3d(0.0,0.0,1.0156),geom.Pos3d(10.0038,0.0,0.8565))
...
## Truss D
lowerChordAxisD= geom.Segment3d(geom.Pos3d(12.4422,0.0,0.0),geom.Pos3d(21.9888,0.0,0.0))
upperChordAxisD= geom.Segment3d(geom.Pos3d(12.4422,0.0,.8057),geom.Pos3d(21.9888,0.0,0.6068))
...
trussD.upperChordMaterial= lowerChordSection
...
modelSpace.constraints.newEqualDOF(trussDUpperChordBackEnd.getNode().tag,joist_B.getNode().tag,xc.ID([0,1,2,3]))
...
def reportResults(combName):
    writeResults(combName,' roof', [trussC,trussD])
