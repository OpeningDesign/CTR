...
# joistSection= sp.RectangularSection('joistSection',3.5*inch2meter,6*inch2meter)
# Ryan asks for a cheaper solution 20191203 
joistSection= sp.RectangularSection('joistSection',(2+2)*inch2meter,6*inch2meter)
...
def getLVLFb(depth):
    '''Return allowable stress according to the document:
       ...
       page 4. THIS IS THE VOLUME FACTOR.
    '''
    retval= 2900
    in12= 12.0*inch2meter
    in3_5= 3.5*inch2meter
    if(depth>in12):
