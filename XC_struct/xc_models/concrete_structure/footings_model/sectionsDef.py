...
for row in reader:
    ...
    rcSects[id]= element_section_map.RCSlabBeamSection(name=sName,sectionDescr=sDescr,concrType=concrete, reinfSteelType=reinfSteel,depth= thickness)
csvFile.close()
...
footingRCSect= element_section_map.RCSlabBeamSection(name='footingRCSect',sectionDescr="footing.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.50)
