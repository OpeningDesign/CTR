...
\begin{tabular}[H]{|l|}
\hline
\multicolumn{1}{|c|}{\textsc{RWpinned_east}}\\
\hline
\begin{tabular}{c|l}
\begin{minipage}{85mm}
\vspace{2mm}
\begin{center}
\includegraphics[width=80mm]{RWpinned_east}
\end{center}
\vspace{1pt}
\end{minipage} & 
\begin{tabular}{l}
...
\hline
\end{tabular}
\caption{Wall materials and dimensions RWpinned_east} \label{tb_def_RWpinned_east}
\end{center}
\end{table}
\begin{center}
...
\end{tabular}
\end{center}
\bottomcaption{RWpinned_east wall reinforcement} \label{tb_RWpinned_east}
\tablefirsthead{\hline
\multicolumn{1}{|c|}{\textsc{Reinforcements mur RWpinned_east}}\\\hline
}
\tablehead{\hline
\multicolumn{1}{|c|}{\textsc{RWpinned_east (suite)}}\\\hline
}
