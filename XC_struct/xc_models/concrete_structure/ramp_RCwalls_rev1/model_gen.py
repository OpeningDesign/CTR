...
beamsYsteel=modelSpace.setSum('beamsYsteel',[WbeamYsteel,CbeamYsteel,EbeamYsteel])
#out.displayFEMesh(setsToDisplay=beamSets+wallSets)
#out.displayLocalAxes()
beams=modelSpace.setSum('beams',[beamXsteel,WbeamYsteel,CbeamYsteel,EbeamYsteel])
steelMembers=modelSpace.setSum('steelMembers',beamSets)
steelMembers.description='Cantilever steel structure'
walls=modelSpace.setSum('walls',[EastBasementWall,East1FloorWall,South1FloorWall,WestBasementWall,West1FloorWall])
walls.description='Ramp RC walls'
overallSet=modelSpace.setSum('overallSet',beamSets+wallSets)
...
lnEW2F=modelSpace.setSum('lnEW2F',[lnE2F,lnW2F])
...
#Choose load case to be used in verification
execfile(workingDirectory+'load_cases_general_verification.py')
#execfile(workingDirectory+'load_cases_only_cantilever_loaded.py')
