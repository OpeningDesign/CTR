...
sect2Disp=[EBwallRCSects,WBwallRCSects,E1FwallRCSects,W1FwallRCSects,S1FwallRCSects] #reinforced concrete sections to display
                                    #from those defined in sectDataInputFile
report_graphics_outDir= cfg.projectDirTree.getReportSectionsGrPath()
report_graphics_rltv_outDir=cfg.projectDirTree.getRltvReportSectionsGrPath()
...
for sect in sect2Disp:
  ...
  textRltvFileName=report_graphics_rltv_outDir+sect1.sectionName+'.tex'
  epsFileName=report_graphics_outDir+sect1.sectionName+'.eps'
  epsRltvFileName=report_graphics_rltv_outDir+sect1.sectionName+'.eps'
  ...
  grRltvFileName=report_graphics_rltv_outDir+sect1.sectionName+'NMy'
  plotIntDiag(diag=diagNMy,title=sect1.sectionName+ ' N-My interaction diagram',xAxLab='My [kNm]',yAxLab='N [kN]',grFileNm=grFileName,reportFile=report,grRltvFileNm=grRltvFileName)
  diagNMz= sect1.defInteractionDiagramNMz(preprocessor)
  grFileName=report_graphics_outDir+sect1.sectionName+'NMz'
  grRltvFileName=report_graphics_rltv_outDir+sect1.sectionName+'NMz'
  plotIntDiag(diag=diagNMz,title=sect1.sectionName+ ' N-Mz interaction diagram',xAxLab='Mz [kNm]',yAxLab='N [kN]',grFileNm=grFileName,reportFile=report,grRltvFileNm=grRltvFileName)
  #Section 2
  # plotting of section geometric and mechanical properties
  sect2inf=section_report.SectionInfoHASimple(preprocessor,sect2)
  texFileName=report_graphics_outDir+sect2.sectionName+'.tex'
  texRltvFileName=report_graphics_rltv_outDir+sect2.sectionName+'.tex'
  epsFileName=report_graphics_outDir+sect2.sectionName+'.eps'
  epsRltvFileName=report_graphics_rltv_outDir+sect2.sectionName+'.eps'
  ...
  grRltvFileName=report_graphics_rltv_outDir+sect2.sectionName+'NMy'
  plotIntDiag(diag=diagNMy,title=sect2.sectionName+ ' N-My interaction diagram',xAxLab='My [kNm]',yAxLab='N [kN]',grFileNm=grFileName,reportFile=report,grRltvFileNm=grRltvFileName)
  diagNMz= sect2.defInteractionDiagramNMz(preprocessor)
  grFileName=report_graphics_outDir+sect2.sectionName+'NMz'
  grRltvFileName=report_graphics_rltv_outDir+sect2.sectionName+'NMz'
  plotIntDiag(diag=diagNMz,title=sect2.sectionName+ ' N-Mz interaction diagram',xAxLab='Mz [kNm]',yAxLab='N [kN]',grFileNm=grFileName,reportFile=report,grRltvFileNm=grRltvFileName)
'''  
