...
Dead_Wcant=30.78e3  #dead load steel cantilever (West side) [N/m]
Live_Wcant=23.78e3
Snow_Wcant=10.35e3

Dead_Ccant=44.65e3  #dead load steel cantilever (Central) [N/m]
Live_Ccant=39.04e3
Snow_Ccant=15.49e3

ratio=(xEastWall-xHall)/(xWestWall-xEastWall)

Dead_Ecant=ratio*Dead_Wcant  #dead load steel cantilever (East side) [N/m]
