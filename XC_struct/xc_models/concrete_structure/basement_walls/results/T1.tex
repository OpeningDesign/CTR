...
Bearing capacity:  & 0.53 & 1.00 & EQ1609A\\
...
\end{tabular}
\end{center}
\bottomcaption{T1 wall reinforcement} \label{tb_T1}
\tablefirsthead{\hline
\multicolumn{1}{|c|}{\textsc{T1 wall reinforcement}}\\\hline
}
\tablehead{\hline
\multicolumn{1}{|c|}{\textsc{T1 (suite)}}\\\hline
}
